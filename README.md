...
Infrastructure / 工程落地: Built an automated data pipeline using Python (SQLAlchemy) to fetch data directly from the MySQL database, 

replacing manual exports. (使用 Python SQLAlchemy 构建自动化数据链路，直接从数据库提取数据)
